...
Insights
Settings
python_binance_autotrade / start_asynhio_BTC_RUB.py /
...
while True:
    ...
    if time_hour != str(time.strftime("%H")):
        ...
        balance_ETH_asset, balance_ETH_free, balance_ETH_locked = balance_ETH["asset"], float(
            balance_ETH["free"]), float(balance_ETH["locked"])
        ...
        balance_RUB_asset, balance_RUB_free, balance_RUB_locked = balance_RUB["asset"], float(
            balance_RUB["free"]), float(balance_RUB["locked"])
        ...
        balance_AXS_asset, balance_AXS_free, balance_AXS_locked = balance_AXS["asset"], float(
            balance_AXS["free"]), float(balance_AXS["locked"])
        ...
        tasks = [ioloop.create_task(control_balance_BTC()), ioloop.create_task(control_balance_RUB()),
                 ioloop.create_task(start_BTCRUB()), ioloop.create_task(BTCRUBorder()),
                 ioloop.create_task(control_balance_ETH()), ioloop.create_task(start_ETHBTC()),
                 ioloop.create_task(ETHBTCorder()),
                 ioloop.create_task(control_balance_AXS()), ioloop.create_task(start_AXSBTC()),
                 ioloop.create_task(AXSBTCorder()),
